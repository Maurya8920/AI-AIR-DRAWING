 ...
 * On mobile (<768px), structures into Row 1 (tools, history, colours) and Row 2 (sizes, save, actions).
 */
...
export default function Toolbar({
  ...
  return (
    <div className="toolbar glass-toolbar camera-toolbar">
      {/* Row 1 on Mobile: Tools, History, Colours */}
      ...
      <div className="toolbar-row-divider desktop-only-divider" />

      {/* Row 2 on Mobile: Brush Sizes, Save & Camera Controls */}
